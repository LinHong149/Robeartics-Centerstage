...
public class GenericDetector implements Runnable{
    ...
    private String modelFileName = "pixel_test.tflite";//"croppedRingRec.tflite";
    private String labelFileName = "labels.txt";//"croppedLabels.txt";
    private static Classifier.Model MODEl_TYPE = Classifier.Model.FLOAT_EFFICIENTNET;
    private static final String LABEL_A = "NO_PIXEL";
    private static final String LABEL_B = "PIXEL";

    private String result = LABEL_A; //just a default value.
