...
import org.firstinspires.ftc.teamcode.Pipeline.BlueDetectionPipeline;
...
@TeleOp(name="BlueAuton", group="Linear Opmode")
public class BlueAuton extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            BlueDetectionPipeline.Position position = pipeline.getPosition();
